...
- Name: e2e-ai.spec.js >> AI-powered User Authentication and Navigation >> AI should confirm registration form has correct fields
- Location: tests\e2e-ai.spec.js:64:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/auth?tab=register
Call log:
  - navigating to "http://localhost:3000/auth?tab=register", waiting until "load"
